...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=24&duration=3000&pause=800&color=00F7FF&center=true&vCenter=true&width=600&lines=Full+Stack+Developer;Ex+AI+Engineer+%40+Samsung;FDSE+%40+UnifyApps;Building+Scalable+Systems+%F0%9F%9A%80" />
</p>
...
-  Ex **Software development Intern @ Samsung**
-  **Knight@Leetcode (1900+), Specialist@Codeforces(1450+)**  
...
**Frameworks:**  
`React.js` `Next.js` `Flask` `Express.js` `Fast-API` `PyTorch` `Node.js`
